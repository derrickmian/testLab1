...
Console.WriteLine("My name is Derrick Mian");
Console.WriteLine("Version: {0}", Environment.Version.ToString());

//Completed on Today's Date of January 28th, 2024"
// Task 2 is completed by Derrick Mian

string myText = "I love to code!";

Console.WriteLine(myText);

int myNum = 15;
Console.WriteLine("myNum was: " + myNum);
myNum = 20; //Changes myNum to 20
...
string[] names2 = new[] { "Derrick", "Omie", "Danny", "Rita" };
...
{
  { "Aa", "Bb", "Cc", "Dd", "Ee" },
  { "Clark", "Guillo", "Fanta", "Arnelle", "Chris" },
  { "Snake", "Lizard", "Fox", "Monkey", "Kangaroo" }
};
...
{
  new[] { "Aa", "Bb", "Cc" },
  new[] { "Clark", "Guillo", "Fanta", "Arnelle" },
  new[] { "Snake", "Lizard" }
};
